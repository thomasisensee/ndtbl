...
if read_the_docs_build:
    ...
    subprocess.check_call(
        "cmake -Dndtbl_BUILD_DOCS=ON -Dndtbl_BUILD_TESTING=OFF  ../..".split(),
        cwd=builddir,
    )
    subprocess.check_call(
        "cmake --build . --target ndtbl-doxygen".split(), cwd=builddir
    )
    breathe_projects["ndtbl"] = os.path.join(builddir, "doc", "xml")
